...
```
Since we have scaled all the columns with variance equal to 1, this fact implies that the covariance-variance matrix is equal to the correlation matrix.

> Source: https://math.stackexchange.com/questions/3780344/under-what-conditions-will-the-covariance-matrix-be-identical-to-the-correlation
