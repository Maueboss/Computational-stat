...
# performs this 100 time and only then the author applies both methods (cross 
# validationand bagging). After this he recreates the division and compute the mean
# squared errors
...
k_fold_reg_tree= function(df,k, y){
  ...
  # In this step we are dividing the training set in 10 folds to apply 10-fold 
  # cross validation
...
reg_tree_boot= function(df,b, y){
  ...
  # training set. Determines a nested sequence of subtrees of the supplied rpart
  # object by recursively snipping off the least important splits, 
